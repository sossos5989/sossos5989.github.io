...
### 알고 가면 좋은 것
이 문제는 Set Cover라는 문제로, 계산이론쪽에서 유명한 **NP-complete**문제입니다.
...
사실 이 $backtrack$함수에는 결점이 있는데, $food$를 중복으로 골라서 $count$가 더 측정이 될 수 있는 점입니다.
...
### 최종 코드
[여기](https://github.com/sossos5989/algospot/blob/main/allergy.cc)에서 확인하세요!
...
저와 동작시간과 작동 매커니즘은 비슷하나, 엄청나게 단축시킨 코드를 봅시다!
...
특징은, bitmask를 잘 활용하기 위해 아예 **친구들이 먹을 수 있는 음식의 종류를 bitmask처리**해서 OR연산에 사용할 수 있도록 하는 게 인상깊었습니다.
